...
export class ServiceController {
  ...
  @ApiQuery({
    ...
    type: String,
    example: '',
    description: 'Search by service title, description, or business keywords',
  })
  @ApiQuery({
    name: 'title',
    required: false,
  ...
  @ApiQuery({
    ...
    example: 'plumbing',
    description:
      'Case-insensitive partial search by service title, description, business keywords, service category, or subcategory fields',
  })
  @ApiQuery({
    name: 'state',
    required: false,
    type: String,
    example: 'Texas',
    description: 'Case-insensitive exact state filter',
  })
  @ApiQuery({
    name: 'city',
    required: false,
  ...
  @ApiQuery({
    ...
    example: '',
    description:
      'Global case-insensitive partial search across public business-profile, service, service-category, and subcategory fields',
  })
  @ApiQuery({
    name: 'category',
    required: false,
